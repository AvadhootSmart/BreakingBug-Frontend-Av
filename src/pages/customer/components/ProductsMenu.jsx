...
import { getProducts, getSearchedProducts, getSpecificProducts } from "../../../redux/userHandle";
...
const ProductsMenu = ({ dropName }) => {
  ...
  const catHandler = (key) => {
    ...
    if (dropName === "Categories") {
      dispatch(getSpecificProducts("searchProductbyCategory", key));
    } else {
      dispatch(getSpecificProducts("searchProductbySubCategory", key));
    }
